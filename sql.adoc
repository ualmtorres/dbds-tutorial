= Bases de datos para Ciencia de datos - SQL
...
Actúan sobre un conjunto de filas y devuelven un único valor resumen. Si no se usan cláusulas de agrupación (`GROUP BY`, que veremos más adelante), actúan sobre todas las filas devueltas por la consulta.
